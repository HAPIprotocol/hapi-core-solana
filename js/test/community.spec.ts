...
describe('Community', () => {
  const BINARY_SAMPLE = Buffer.from('01ef37a50404b188a96e10f551122753f8ae8906c4ae0983c92727acf25b38f95108000000686170692e6f6e65', 'hex');
  ...
  it('should serialize', () => {
    expect(COMMUNITY_SAMPLE.serialize())
      .toEqual(BINARY_SAMPLE);
  });

  it('should deserialize', () => {
    expect(Community.deserialize(BINARY_SAMPLE))
      .toEqual(COMMUNITY_SAMPLE);
  });
